  ...
  public: {
    Tables: {
      ...
      estimates: {
        ...
        Relationships: [
          {
            foreignKeyName: "estimates_car_id_fkey"
            columns: ["car_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "estimates_studio_id_fkey"
            columns: ["studio_id"]
            isOneToOne: false
            referencedRelation: "studios"
            referencedColumns: ["id"]
      ...
      inventory_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventory_transactions_studio_id_fkey"
            columns: ["studio_id"]
            isOneToOne: false
            referencedRelation: "studios"
            referencedColumns: ["id"]
      ...
      job_assignment_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_assignment_requests_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "jobs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "job_assignment_requests_requested_by_fkey"
          ...
          {
            foreignKeyName: "job_assignment_requests_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "job_assignment_requests_studio_id_fkey"
            columns: ["studio_id"]
            isOneToOne: false
            referencedRelation: "studios"
            referencedColumns: ["id"]
